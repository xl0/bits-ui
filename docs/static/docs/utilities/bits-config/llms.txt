...
| ----------------- | --------------------------- | ------------------------------------------------------------------------------------------ | ------- |
| `defaultPortalTo` | `union` - Element \| string | Where to render the content when it is open. Defaults to the body.`Default: document.body` |         |
| `defaultLocale`   | `string`                    | The default locale to use for the app.`Default: en`                                        |         |
| `children`        | `Snippet`                   | The children content to render.`Default:  —— undefined`                                    |         |

[Previous Tooltip](/docs/components/tooltip) [Next IsUsingKeyboard](/docs/utilities/is-using-keyboard)